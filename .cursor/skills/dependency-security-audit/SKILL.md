...
- Соблюдать контекст проекта: читать [docs/new-agents.md](../../../docs/new-agents.md) как источник gotchas/конвенций; на Windows использовать `npm.cmd`/`py -m ...` при проблемах с PATH.
